...
<?php echo '<p style="text-align:center;fon-size:120%:font-family:arial">Serverillä oleva aika  . date("h:i:sa");</p>'; ?>
<?php date_default_timezone_set("Europe/Helsinki"); echo "The time is " . date("h:i:sa"); ?>
</body>
</html>
